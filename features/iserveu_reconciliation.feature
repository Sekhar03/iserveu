  ...
  # ---------------------------------------------------------------------------
        ...
        Scenario Outline: Sequential 6-step wizard execution for AEPS sub-products
            Given the user selects category "AEPS" on Step 1 "Category Selection"
             ...
             Then an initiation modal appears stating "Reconciliation process for <SubProductName> (2026-07-28 — Cycle 1 (00:00 - 03:00 Window)) has been initiated. Completed results are available in the Report section." without timer countdown
