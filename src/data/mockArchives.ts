...
const archive1 = generateReconDataset('nsdlaeps', 'NSDL AEPS', 'AEPS', '2026-07-28', 'Cycle 1 (00:00 - 03:00 Window)', 15800);
...
const archive3 = generateReconDataset('matm4way', 'MATM 4-Way Txn Recon', 'MATM', '2026-07-27', 'Cycle 6 (15:00 - 18:00 Window)', 8900);
...
const archive5 = generateReconDataset('airteldmt', 'Airtel DMT', 'DMT', '2026-07-25', 'Cycle 3 (06:00 - 09:00 Window)', 17800);
archive5.job.id = 'RECON-20260725-008';

const archive6 = generateReconDataset('bbpsbou', 'Bharat Connect BOU', 'BHARAT CONNECT', '2026-07-25', 'All Cycles (Daily Consolidated)', 11200);
archive6.job.id = 'RECON-20260725-002';

const archive7 = generateReconDataset('pos_sub', 'POS', 'POS', '2026-07-24', 'Cycle 1 (00:00 - 03:00 Window)', 14500);
archive7.job.id = 'RECON-20260724-005';

const archive8 = generateReconDataset('wallet2cashout', 'Wallet2Cashout', 'Payout', '2026-07-24', 'Cycle 4 (09:00 - 12:00 Window)', 16800);
...
const archive10 = generateReconDataset('bobproject_sub', 'BOB Project', 'BOB PROJECT', '2026-07-23', 'Cycle 1 (00:00 - 03:00 Window)', 15400);
