...
const archive1 = generateReconDataset('nsdlaeps', 'NSDL AEPS', 'AEPS', '2026-07-28', 'Cycle 1 (00:00 - 06:00 Window)', 15800);
...
const archive3 = generateReconDataset('matm4way', 'MATM 4-Way Txn Recon', 'MATM', '2026-07-27', 'Cycle 3 (12:00 - 18:00 Window)', 8900);
...
const archive5 = generateReconDataset('airteldmt', 'Airtel DMT', 'DMT', '2026-07-25', 'Cycle 2 (06:00 - 12:00 Window)', 17800);
...
const archive7 = generateReconDataset('pos_sub', 'POS', 'POS', '2026-07-24', 'Cycle 1 (00:00 - 06:00 Window)', 14500);
archive7.job.id = 'RECON-20260724-005';

const archive8 = generateReconDataset('wallet2cashout', 'Wallet2Cashout', 'Payout', '2026-07-24', 'Cycle 2 (06:00 - 12:00 Window)', 16800);
...
const archive10 = generateReconDataset('bobproject_sub', 'BOB Project', 'BOB PROJECT', '2026-07-23', 'Cycle 1 (00:00 - 06:00 Window)', 15400);
