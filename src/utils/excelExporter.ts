...
export const SAMPLE_NPCI_FILE_COLUMNS = [
  'TXN TYPE',
  'SWITCH TXN ID',
  'RRN',
  'RESPONSE CODE',
...
export const SAMPLE_NPCI_FILE_ROWS = [
  {
    'TXN TYPE': 'U2',
    'SWITCH TXN ID': 'NPT00000000000000539111663263220264',
    'RRN': '6.19741E+11',
    'RESPONSE CODE': '0',
    'TXN DATE': '71626',
    'TXN TIME': '170723',
    ...
    'PAYER CODE': 'AXT',
    'PAYER MCC': '0',
    'payer VPA': 'murthy05murthy@ptaxis',
    'PAYEE CODE': 'NPT',
    'PAYEE MCC': '7311',
    'payee VPA': '156830062026.mp@nsdlpbma',
    'REM CODE': 'BOB',
    'REM IFSC CODE': 'BARB0VJKNPU',
    'REM ACCOUNT TYPE': '1',
    'REM ACCOUNT NO': '8.93801E+13',
    'BENE CODE': 'NPT',
    'BENE IFSC': 'NSPB0000016',
    'BENE ACCOUNT TYPE': '2',
    'BENE ACCOUNT NO': '5.02004E+11',
    'AMOUNT': '300'
  },
  {
    'TXN TYPE': 'U2',
    'SWITCH TXN ID': 'NPT00000000000000539111663263220265',
    'RRN': '6.19741E+11',
    'RESPONSE CODE': '0',
    'TXN DATE': '71626',
    'TXN TIME': '170845',
    ...
    'PAYER CODE': 'AXT',
    'PAYER MCC': '0',
    'payer VPA': 'anand.k@okaxis',
    'PAYEE CODE': 'NPT',
    'PAYEE MCC': '7311',
    'payee VPA': '156830062027.mp@nsdlpbma',
    'REM CODE': 'HDFC',
    'REM IFSC CODE': 'HDFC0000128',
    'REM ACCOUNT TYPE': '1',
    'REM ACCOUNT NO': '5.01002E+13',
    'BENE CODE': 'NPT',
    'BENE IFSC': 'NSPB0000016',
    'BENE ACCOUNT TYPE': '2',
    'BENE ACCOUNT NO': '5.02004E+11',
...
export function exportSampleFile(format: 'xlsx' | 'csv' = 'xlsx', fileName = 'sample_npci_recon_file') {
  const worksheet = XLSX.utils.json_to_sheet(SAMPLE_NPCI_FILE_ROWS, { header: SAMPLE_NPCI_FILE_COLUMNS });
  const workbook = XLSX.utils.book_new();
